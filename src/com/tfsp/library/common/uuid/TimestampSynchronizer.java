 ...
 */
/* 
 * 文件名: com.tfsp.library.common.uuid.TimestampSynchronizer.java
 *
 * 修改记录
 * +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 * 修改日期				修改者						备注信息
...
public abstract class TimestampSynchronizer {
	...
	/**
	 * Initialization method is will be called on an instance by {@link UUIDTimer} right after it's been configured with one.
	 ...
	 * <p>
	 * Return value thus indicates the lowest initial time value that can be used by the caller that can not have been used by previous incarnations of the UUID
	 * generator (assuming instance was able to find properly persisted data to figure that out). However, caller also needs to make sure that it will call
	 * {@link #update} when it actually needs the time stamp for the first time, since this method can not allocate timestamps beyond this initial value at this
	 * point.
	 * 
